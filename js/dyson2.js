...
/*傳送表單*/
    function sendform(){
      ...
      if(hasClass(check, 'disabled')){
        ...
        $.get("https://script.google.com/macros/s/AKfycbwLItpwTa5tbsGFPMTK2XF4J2Z7kz4VaKrRphBbatLJbmFP5UM/exec", {
         ...
         window.location.href("http://www.yesim.tw/blink/thank.html");
